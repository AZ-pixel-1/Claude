...
if "--live" in sys.argv:
    ...
    race_data = [
        ...
        ("2026-02-20", 375.0), ("2026-02-28", 360.0), ("2026-03-06", 345.0),
        ("2026-03-13", 334.0), ("2026-03-16", 332.0),
    ]
    ...
    stla_data = [
        ...
        ("2026-02-20", 7.51),  ("2026-02-26", 7.80),  ("2026-02-27", 5.95),
        ("2026-03-06", 6.80),  ("2026-03-13", 6.50),  ("2026-03-16", 6.50),
    ]
    ...
    phg_data = [
        ...
        ("2026-02-17", 31.17), ("2026-02-28", 30.50), ("2026-03-09", 29.40),
        ("2026-03-11", 28.80), ("2026-03-16", 28.00),
    ]
    ...
    cnh_data = [
        ...
        ("2026-02-20", 13.05), ("2026-02-28", 12.00), ("2026-03-09", 11.00),
        ("2026-03-16", 10.65),
    ]
    ...
    ivg_data = [
        ...
        ("2026-02-08", 18.95), ("2026-02-28", 19.00), ("2026-03-05", 19.08),
        ("2026-03-09", 19.03), ("2026-03-16", 19.00),
    ]
    ...
    juve_data = [
        ...
        ("2026-02-20", 2.29),  ("2026-02-28", 2.30),  ("2026-03-09", 2.30),
        ("2026-03-16", 2.30),
    ]
    ...
    exo_data = [
        ...
        ("2026-01-30", 73.80), ("2026-02-20", 74.05), ("2026-02-28", 72.50),
        ("2026-03-04", 72.20), ("2026-03-06", 70.50), ("2026-03-12", 68.50),
        ("2026-03-16", 68.20),
    ]
    ...
    eurusd_data = [
        ...
        ("2026-02-20", 1.178), ("2026-02-28", 1.165), ("2026-03-06", 1.155),
        ("2026-03-13", 1.147), ("2026-03-16", 1.148),
    ]
    ...
    idx = pd.bdate_range(start="2024-02-21", end="2026-03-16")
