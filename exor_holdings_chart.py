...
if "--live" in sys.argv:
    ...
    race_data = [
        ...
        ("2025-11-28", 388.0),
        # Daily data Dec 2025 – Mar 2026 (IBKR-sourced where confirmed)
        ("2025-12-15", 348.0), ("2025-12-19", 344.0), ("2025-12-23", 342.5),
        ("2025-12-26", 341.5), ("2025-12-31", 338.0),
        ("2026-01-02", 337.0), ("2026-01-06", 335.5), ("2026-01-09", 334.0),
        ("2026-01-13", 333.0), ("2026-01-16", 331.5), ("2026-01-20", 331.0),
        ("2026-01-23", 329.5), ("2026-01-27", 328.5), ("2026-01-28", 328.0),
        ("2026-01-30", 330.0),
        ("2026-02-02", 328.0), ("2026-02-03", 328.0),  # 52-week low
        ("2026-02-05", 332.0), ("2026-02-07", 334.0),
        ("2026-02-10", 338.0), ("2026-02-12", 345.0), ("2026-02-13", 350.0),
        ("2026-02-17", 374.99),  # confirmed
        ("2026-02-19", 370.0), ("2026-02-20", 368.0),
        ("2026-02-23", 365.0), ("2026-02-25", 362.80),  # post-Q4 earnings
        ("2026-02-27", 358.0),
        ("2026-03-02", 355.0), ("2026-03-04", 350.0), ("2026-03-06", 345.0),
        ("2026-03-09", 340.0), ("2026-03-10", 338.0), ("2026-03-11", 336.0),
        ("2026-03-12", 334.55), ("2026-03-13", 331.86),  # confirmed
    ]
    ...
    stla_data = [
        ...
        ("2025-11-28", 14.00),
        # Daily data Dec 2025 – Mar 2026
        ("2025-12-15", 14.30), ("2025-12-19", 14.20), ("2025-12-23", 14.15),
        ("2025-12-26", 14.15), ("2025-12-31", 14.20),
        ("2026-01-02", 14.00), ("2026-01-06", 13.60), ("2026-01-09", 13.00),
        ("2026-01-13", 12.60), ("2026-01-16", 12.00), ("2026-01-20", 11.80),
        ("2026-01-23", 11.40), ("2026-01-27", 11.20), ("2026-01-30", 10.80),
        ("2026-02-02", 10.40), ("2026-02-03", 10.00), ("2026-02-04", 9.80),
        ("2026-02-05", 9.54),   # confirmed
        ("2026-02-06", 7.03),   # confirmed – massive drop
        ("2026-02-07", 7.30),   # confirmed – buy signal
        ...
        ("2026-02-26", 7.80),
        ("2026-02-27", 5.95),   # confirmed – major drop
        ("2026-03-02", 6.00), ("2026-03-03", 6.20), ("2026-03-04", 6.40),
    ...
    phg_data = [
        ...
        ("2025-11-28", 22.00),
        # Daily data Dec 2025 – Mar 2026
        ("2025-12-15", 23.20), ("2025-12-19", 23.10), ("2025-12-23", 23.10),
        ("2025-12-26", 23.10), ("2025-12-31", 23.10),
        ("2026-01-02", 23.30), ("2026-01-06", 23.80), ("2026-01-09", 24.40),
        ("2026-01-13", 24.80), ("2026-01-16", 25.40), ("2026-01-20", 25.80),
        ("2026-01-23", 26.50), ("2026-01-27", 27.00), ("2026-01-30", 27.50),
        ("2026-02-03", 27.90), ("2026-02-05", 28.40), ("2026-02-06", 28.80),
        ("2026-02-07", 29.45),  # confirmed
        ("2026-02-10", 29.80), ("2026-02-12", 30.20), ("2026-02-13", 30.50),
        ("2026-02-17", 31.17),  # confirmed
        ("2026-02-19", 30.80), ("2026-02-20", 30.60),
        ("2026-02-23", 30.50), ("2026-02-25", 30.30), ("2026-02-27", 30.10),
        ("2026-03-02", 30.00), ("2026-03-04", 29.70), ("2026-03-06", 29.50),
    ...
    cnh_data = [
        ...
        ("2025-11-28", 11.00),
        # Daily data Dec 2025 – Mar 2026
        ("2025-12-15", 10.60), ("2025-12-19", 10.50), ("2025-12-23", 10.50),
        ("2025-12-26", 10.50), ("2025-12-31", 10.50),
        ("2026-01-02", 10.45), ("2026-01-06", 10.35), ("2026-01-09", 10.28),
        ("2026-01-12", 10.26),  # confirmed
        ("2026-01-14", 10.35), ("2026-01-16", 10.45),
        ("2026-01-20", 10.55), ("2026-01-23", 10.70), ("2026-01-27", 10.90),
        ("2026-01-30", 11.20),
        ("2026-02-03", 11.60), ("2026-02-05", 12.00), ("2026-02-07", 12.30),
        ("2026-02-10", 12.50), ("2026-02-12", 12.70), ("2026-02-13", 12.80),
        ("2026-02-17", 13.00),
        ("2026-02-20", 13.05),  # confirmed
        ("2026-02-23", 12.73),  # confirmed
        ("2026-02-25", 11.95),  # confirmed – post-earnings drop
        ("2026-02-26", 11.80), ("2026-02-27", 11.60),
        ("2026-03-02", 11.40), ("2026-03-04", 11.20), ("2026-03-06", 11.00),
        ("2026-03-09", 10.90), ("2026-03-10", 10.85), ("2026-03-11", 10.80),
        ("2026-03-12", 10.75),  # confirmed
    ...
    ivg_data = [
        ...
        ("2025-11-28", 18.00),
        # Daily data Dec 2025 – Mar 2026
        ("2025-12-15", 17.60), ("2025-12-19", 17.50), ("2025-12-23", 17.50),
        ("2025-12-26", 17.50), ("2025-12-31", 17.50),
        ("2026-01-02", 17.60), ("2026-01-06", 17.75), ("2026-01-09", 17.90),
        ("2026-01-13", 18.00), ("2026-01-16", 18.15), ("2026-01-20", 18.25),
        ("2026-01-23", 18.40), ("2026-01-27", 18.45), ("2026-01-30", 18.50),
        ...
        ("2026-03-06", 19.05),
        ("2026-03-09", 19.03), ("2026-03-10", 19.05), ("2026-03-11", 19.08),
        ("2026-03-12", 19.06), ("2026-03-13", 19.08),
    ]
    ...
    juve_data = [
        ...
        ("2025-11-28", 2.50),
        # Daily data Dec 2025 – Mar 2026
        ("2025-12-15", 2.42), ("2025-12-19", 2.40), ("2025-12-23", 2.40),
        ("2025-12-26", 2.40), ("2025-12-31", 2.40),
        ("2026-01-02", 2.39), ("2026-01-06", 2.38), ("2026-01-09", 2.37),
        ("2026-01-13", 2.36), ("2026-01-16", 2.35), ("2026-01-20", 2.35),
        ("2026-01-23", 2.35), ("2026-01-27", 2.35), ("2026-01-30", 2.35),
        ("2026-02-03", 2.34), ("2026-02-05", 2.33), ("2026-02-07", 2.32),
        ("2026-02-10", 2.31), ("2026-02-12", 2.30), ("2026-02-13", 2.30),
        ("2026-02-17", 2.29), ("2026-02-19", 2.29),
        ("2026-02-20", 2.29),  # confirmed
    ...
    exo_data = [
        ...
        ("2026-01-02", 74.40), ("2026-01-06", 74.10), ("2026-01-09", 73.80),
        ("2026-01-13", 73.60),  # confirmed
        ...
        ("2026-02-17", 70.00), ("2026-02-19", 73.00),
        ...
        ("2026-03-11", 70.50), ("2026-03-12", 69.50),
        ("2026-03-13", 68.50),
    ]
    ...
    eurusd_data = [
        ...
        # Daily data Dec 2025 – Mar 2026
        ("2025-12-15", 1.128), ("2025-12-19", 1.130), ("2025-12-23", 1.132),
        ("2025-12-26", 1.134), ("2025-12-31", 1.135),
        ("2026-01-02", 1.138), ("2026-01-06", 1.144), ("2026-01-09", 1.153),
        ("2026-01-13", 1.159), ("2026-01-16", 1.168), ("2026-01-20", 1.175),
        ("2026-01-23", 1.190),
        ("2026-01-27", 1.2019),  # confirmed – 2026 high
        ("2026-01-30", 1.188),
        ("2026-02-03", 1.184), ("2026-02-05", 1.181), ("2026-02-07", 1.180),
        ("2026-02-10", 1.179), ("2026-02-12", 1.179), ("2026-02-13", 1.180),
        ("2026-02-17", 1.179), ("2026-02-19", 1.179),
        ("2026-02-20", 1.1785),  # confirmed
        ("2026-02-23", 1.176), ("2026-02-25", 1.172),
        ("2026-02-27", 1.168),
        ("2026-03-02", 1.165), ("2026-03-04", 1.161), ("2026-03-06", 1.155),
        ("2026-03-09", 1.1523),  # confirmed
        ("2026-03-10", 1.150), ("2026-03-11", 1.148),
        ("2026-03-12", 1.146),
        ("2026-03-13", 1.144),  # approaching Mar 14 low of 1.1417
    ]
